 ...
 */
@Stateless(name = "SoapHttpClientOneWayService")
@TransactionManagement(TransactionManagementType.BEAN)
@Local(SoapClientLocal.class)
@Remote(JmsPublisherRemote.class)
public class SoapHttpClientOneWayBean extends BaseSoapHttpClient {
    private static Logger log = LoggerFactory.getLogger(SoapHttpClientOneWayBean.class);
    ...
    public String callWS(String content) {
        ...
        testWebServicePort.processOneWay(content);
        return null;
    }
}
