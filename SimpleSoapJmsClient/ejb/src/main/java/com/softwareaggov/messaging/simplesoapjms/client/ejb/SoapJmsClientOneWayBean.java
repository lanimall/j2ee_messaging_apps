 ...
 */
@Stateless(name = "SoapJmsClientOneWayService")
@TransactionManagement(TransactionManagementType.BEAN)
@Local(SoapClientLocal.class)
@Remote(MessageInterop.class)
public class SoapJmsClientOneWayBean extends BaseSoapJmsClient {
    private static Logger log = LoggerFactory.getLogger(SoapJmsClientOneWayBean.class);
