 ...
 */
@WebServlet("/SendSoap")
public class SendSoapCall extends HttpServlet {
    private static final long serialVersionUID = -8314702394752239L;
    private static Logger log = LoggerFactory.getLogger(SendSoapCall.class);

    @EJB(beanName = "SoapHttpClientOneWayService")
    private SoapClientLocal soapHttpClientOneWayService;

    @EJB(beanName = "SoapHttpClientTwoWayService")
    private SoapClientLocal soapHttpClientTwoWayService;
