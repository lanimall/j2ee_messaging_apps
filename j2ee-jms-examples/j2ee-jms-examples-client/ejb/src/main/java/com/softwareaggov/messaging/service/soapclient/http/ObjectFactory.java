 ...
 * generated in the com.softwareaggov.messaging.service.soapclient.http package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetRandomNumberResponse_QNAME = new QName("http://com.softwareaggov.messaging/j2ee-jms-examples/requestreply", "getRandomNumberResponse");
    private final static QName _PerformMultiplicationFromStrings_QNAME = new QName("http://com.softwareaggov.messaging/j2ee-jms-examples/requestreply", "performMultiplicationFromStrings");
    private final static QName _GetRandomNumber_QNAME = new QName("http://com.softwareaggov.messaging/j2ee-jms-examples/requestreply", "getRandomNumber");
    private final static QName _PerformMultiplicationFromStringsResponse_QNAME = new QName("http://com.softwareaggov.messaging/j2ee-jms-examples/requestreply", "performMultiplicationFromStringsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.softwareaggov.messaging.service.soapclient.http
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com.softwareaggov.messaging/j2ee-jms-examples/requestreply", name = "getRandomNumberResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com.softwareaggov.messaging/j2ee-jms-examples/requestreply", name = "performMultiplicationFromStrings")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com.softwareaggov.messaging/j2ee-jms-examples/requestreply", name = "getRandomNumber")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com.softwareaggov.messaging/j2ee-jms-examples/requestreply", name = "performMultiplicationFromStringsResponse")
