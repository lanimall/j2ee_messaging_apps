...
@MessageDriven(name = "MockSleepProcessingMDB")
public class MockSleepProcessingMDB extends AbstractConsumeReply implements MessageListener, MessageDrivenBean {
